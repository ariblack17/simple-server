...
then receives and unpacks a response from the server. Repeats this until
client terminates communications.
...
Request-type header      -> Request-type: multi-request
-------------------------------------------------------------------------------
'''
...
def runClient():
    ...
    ## loop until client terminates communications
    while True:
